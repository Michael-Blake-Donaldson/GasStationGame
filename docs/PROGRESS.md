...
**M0 — Development foundation:** browser/tooling foundation verified; desktop compile awaits the required Rust toolchain.
...
| Desktop Rust shell               | Blocked locally | Current Rust/Cargo 1.80 cannot parse Edition 2024 transitive crates; project requires Rust 1.85+ |
| Desktop release executable       | Blocked locally | `pnpm build:desktop` reaches the same compiler prerequisite; no installer/publish attempted      |
